...
<head>
  ...
  <link rel="stylesheet" href="estilos/pantalon.css">
...
<body>
  <div id="app">
    ...
    <section>
      ...
      <br/>
      <h3 class="bg-info">Pantalones</h3>
      <br/>
      <div class="container">
        <?php
        include "sesion.php";
        ...
        $query="SELECT * FROM productos WHERE tipo = 'pantalon' ORDER BY precio";
              ...
              <div class="row">
                ...
                <div class="col-md-5">
                  <div class="card-body">
                    ...
                    <span v-if="<?php echo $obj->cantidad?> > 1">Has comprado <?php echo $obj->cantidad?> pantalones</span>
                    <span v-if="<?php echo $obj->cantidad?> === 1">Has comprado 1 pantalón</span>
                    <span v-if="<?php echo $obj->cantidad?> === 0"><br/></span>
                    <br/>
                    <span v-if="<?php echo $obj->stock?> > 0">stock disponible: <?php echo $obj->stock?></span>
                    <span v-if="<?php echo $obj->stock?> === 0">Se ha agotado este pantalón</span>
                    <br/><br/>
