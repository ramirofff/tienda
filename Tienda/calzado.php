...
<head>
  ...
  <link rel="stylesheet" href="estilos/calzado.css">
  ...
  <div id="app">
    ...
    <section>
      ...
      <div class="container">
        ...
        $query="SELECT * FROM productos WHERE tipo = 'calzado' ORDER BY precio";
              ...
              <div class="row">
                ...
                <div class="col-md-5">
                  <div class="card-body">
                    ...
                    <span v-if="<?php echo $obj->cantidad?> > 1">Has comprado <?php echo $obj->cantidad?> calzados</span>
                    <span v-if="<?php echo $obj->cantidad?> === 1">Has comprado 1 calzado</span>
                    <span v-if="<?php echo $obj->cantidad?> === 0"><br/></span>
                    <br/>
                    <span v-if="<?php echo $obj->stock?> > 0">stock disponible: <?php echo $obj->stock?></span>
                    <span v-if="<?php echo $obj->stock?> === 0">Se ha agotado este calzado</span>
                    <br/><br/>
